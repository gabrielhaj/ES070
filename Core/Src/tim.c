...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspInit 0 */
    ...
    PB4     ------> TIM16_CH1
    */
    GPIO_InitStruct.Pin = LeftWheelEnc_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM16;
    HAL_GPIO_Init(LeftWheelEnc_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM17_MspInit 0 */
    ...
    PB5     ------> TIM17_CH1
    */
    GPIO_InitStruct.Pin = RightWheelEnc_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* tim_baseHandle)
{
  ...
  /* USER CODE END TIM16_MspDeInit 0 */
    ...
    PB4     ------> TIM16_CH1
    */
    HAL_GPIO_DeInit(LeftWheelEnc_GPIO_Port, LeftWheelEnc_Pin);
  ...
  /* USER CODE END TIM20_MspDeInit 0 */
    ...
    PB2     ------> TIM20_CH1
    */
    HAL_GPIO_DeInit(Ultra_All_Trig_PWM_GPIO_Port, Ultra_All_Trig_PWM_Pin);
