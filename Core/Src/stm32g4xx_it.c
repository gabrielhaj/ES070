...
void EXTI1_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(Frontal_SW_Pin);
...
void EXTI2_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(FrontalSW_Pin);
...
void EXTI9_5_IRQHandler(void)
{
  ...
  HAL_GPIO_EXTI_IRQHandler(EnterBt_Pin);
  HAL_GPIO_EXTI_IRQHandler(UpBt_Pin);
  HAL_GPIO_EXTI_IRQHandler(DownBt_Pin);
  HAL_GPIO_EXTI_IRQHandler(LeftBt_Pin);
  HAL_GPIO_EXTI_IRQHandler(RightBt_Pin);
